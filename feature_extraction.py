...
for i in range(1, nSub + 1):  # tutti i soggetti da 1 a nSub compreso
    ...
    for j in range(1, nEsp + 1):  # tutte le sedute da 1 a nEsp compreso
        ...
        epochs.drop_channels(['COUNTER', 'INTERPOLATED', 'UNIX_TIMESTAMP'])  # droppa bad channels
        ...
        psd_df = epochs.compute_psd(method='welch', tmax=None, fmax=fmax, fmin=fmin)  # calcola psd usando il metodod welch
